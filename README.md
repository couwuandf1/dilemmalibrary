...
- **LoggerProvider**: 统一的日志记录接口，支持多种日志框架（SLF4J、Java Util Logging）
...
```gradle
dependencies {
    implementation 'space.commandf1:dilemmalibrary:1.0-SNAPSHOT'
}
```
...
```java
// 创建日志提供者
LoggerProvider<org.slf4j.Logger> loggerProvider = 
